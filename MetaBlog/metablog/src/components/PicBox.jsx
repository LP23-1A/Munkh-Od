...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center gap-4 pb-[100px]">
      <div className="flex items-center justify-between flex-wrap">
        {data.map((el, index) => {
          return (
            <div className="flex flex-col w-[392px] rounded-xl border p-4 gap-4 border-solid justify-center items-center my-2">
              <div
